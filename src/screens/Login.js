                        ...
                        <div class="col-lg-8 offset-lg-2 col-md-6 offset-md-3">
                            <form onSubmit={(e) => this.signIn(e)} id="login_form" class="box" autocomplete="off">
                                ...
                                <div class="form-group mb-2">
                                    <input value={this.state.username} onChange={(e) => this.setState({ username: e.target.value })} type="text" id="username" name="username" placeholder="Username" class="form-control inputs pb-4 pl-0" />
                                </div>
                                <div class='error error_username'>
                                </div>
                                <div class="form-group">
                                    <input value={this.state.password} onChange={(e) => this.setState({ password: e.target.value })} type="password" id="password" name="password" placeholder="Password" class="form-control inputs pb-4 pl-0" />
                                </div>
