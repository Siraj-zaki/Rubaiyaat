...
export class ReTaggingReport extends Component {
    state = {
        location: "",
        ASN: [],
        device: "",
                    ...
                    <div className="main-dashboard">
                        ...
                        <div className="dashboard ">
                            ...
                            >
                                ...
                                <h1 className="dashboard-heading">Re Tagging (Report)</h1>
                                <Button
                                ...
                                <IconButton style={{ position: "absolute", right: "90px", cursor: 'pointer' }}>
                                    <CSVLink filename="Re Tagging Report" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: 60 }} data={data} headers={headers}>
...
export default ReTaggingReport;
